    ...
    <div class="results">
      ...
      <div class="d-flex mt-space-m">
        <div>
          ...
          <output  class="text-size-2 fw-700 text-neutral-50">{{ results.dailyKwh }} kWh</output>
        </div>
        <div>
          <h3 class="text-size--1">Costo Diario</h3>
          <output  class="text-size-2 fw-700 text-neutral-50">{{ formattedDailyCost }}</output>
        </div>
        <div>
          <h3 class="text-size--1">Costo Mensual</h3>
          <output  class="text-size-2 fw-700 text-neutral-50">{{ formattedMonthlyCost }}</output>
        </div>
        <div>
          <h3 class="text-size--1">Costo Anual</h3>
          <output  class="text-size-2 fw-700 text-neutral-50">{{ formattedAnnualCost }}</output>
        </div>
