<template>
  ...
  <section v-else class="guidance-card rounded-md mt-space-m bg-primary-900 bg-texture">
    <ul role="list" class="guidance-list text-primary-50 m-space-0 d-grid">
      ...
      <li>
        <BarChart2Icon class="icon text-primary-200" />
        <div class="content">
          <p class="text text-primary-50">
            ...
            <span class="tooltip-container">
              <InfoIcon class="icon-small text-primary-50" />
              <div class="tooltip">Porcentaje que representa el precio medio diario respecto al precio máximo del día. Un valor bajo indica que, en promedio, los precios están lejos del pico.</div>
            </span>
          </p>
          <div class="progress-bar">
            <div
              class="progress-fill primary-fill"
              :style="{ width: averageProgressPercentage + '%' }"
            ></div>
          </div>
        </div>
      </li>
      ...
      <li>
        <ZapIcon class="icon text-accent-500" />
        <div class="content">
          <p class="text text-primary-50">
            Ahora estás al <strong>{{ currentProgressPercentage }}%</strong> del pico máximo del día.
            <span class="tooltip-container">
              <InfoIcon class="icon-small text-primary-50" />
              <div class="tooltip">Porcentaje del precio actual en relación al máximo diario. Un % bajo indica un buen momento para consumir.</div>
            </span>
          </p>
          <div class="progress-bar">
            <div
              class="progress-fill accent-fill"
      ...
      <li v-if="nextDifferenceValue !== null">
        <RefreshCwIcon class="icon text-primary-200" />
        <div class="content">
          <p class="text text-primary-50">
          ...
          <p class="subtext text-primary-100 text-size--1 mt-space-2xs">
            {{ nextDifferenceValue > 0
              ...
              : (nextDifferenceValue < 0
                ...
                : 'El precio se mantendrá estable durante la próxima hora.')
            }}
          </p>
        </div>
      </li>
